...
from .sentiment_v2 import SentimentAnalyzerV2
from .clustering_v2 import OpinionClustererV2
from .summarizer_v2 import SummarizerV2
...
class AnalysisPipelineV2:
    ...
    def __init__(self, provider: Optional[str] = None, use_map_reduce: bool = False):
        ...
        self.sentiment_analyzer = SentimentAnalyzerV2(provider=provider)
        self.opinion_clusterer = OpinionClustererV2(provider=provider)
        self.summarizer = SummarizerV2(provider=provider)

        self.logger.info(f"Initialized AnalysisPipelineV2 with provider: {provider}")
